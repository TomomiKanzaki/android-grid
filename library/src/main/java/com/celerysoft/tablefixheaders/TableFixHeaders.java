...
//		this.setVerticalScrollBarEnabled(true);
	...
	public View makeAndSetup(int row, int column, int left, int top, int right, int bottom) {
	...
	public View makeView(int row, int column, int width, int height) {
	...
	private void performItemLongClick() {
		if (onItemLongClickListener != null) {
			onItemLongClickListener.onItemLongClick(this, makeView(touchRowIndex + 1, touchColumnIndex + 1, R.dimen.width, R.dimen.height), touchRowIndex + 1, touchColumnIndex + 1, adapter.getItemId(touchRowIndex + 1, touchColumnIndex + 1));
		}
	}
